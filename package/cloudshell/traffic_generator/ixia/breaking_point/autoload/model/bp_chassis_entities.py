from cloudshell.traffic_generator.ixia.breaking_point.autoload.model.autoload_elements import Resource
from cloudshell.traffic_generator.ixia.breaking_point.autoload.model.parent_aware import ParentAware
